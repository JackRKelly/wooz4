...
export function getSdk(
	...
	return {
		...
		getCartItemCount(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<GetCartItemCountQuery>(
		...
		createCart(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<CreateCartMutation>(CreateCartDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'createCart',
		...
		addCartItem(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<AddCartItemMutation>(AddCartItemDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'addCartItem',
		...
		updateCartItem(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<UpdateCartItemMutation>(
		...
		removeCartItem(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<RemoveCartItemMutation>(
		...
		getProductSingle(
			...
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<GetProductSingleQuery>(
						GetProductSingleDocument,
						variables,
						{...requestHeaders, ...wrappedRequestHeaders},
					),
				'getProductSingle',
